...
![6th Based on the image in the manifest, the image is pulled from Amazon ECR. Kubernetes performs a rolling update of the pods in the application deployment to match the Docker image specified in Amazon ECR. ner ](../../../media/AWS-DevOps-Module-6-23-Amazon-Elastic-Container-Registry-and-Amazon-Elastic-Kubernetes-Service-image16.png){width="5.0in" height="3.3333333333333335in"}



![Sample architecture for a CI/CD pipeline for containers Developers AWS CodeCommit AWS CloudFormation AWS CodePipeline AWS CodeBuild Amazon ECS Amazon ECR ](../../../media/AWS-DevOps-Module-6-23-Amazon-Elastic-Container-Registry-and-Amazon-Elastic-Kubernetes-Service-image17.png){width="5.0in" height="2.875in"}



![1st Developers commit code to an AWS CodeCommit repository. ](../../../media/AWS-DevOps-Module-6-23-Amazon-Elastic-Container-Registry-and-Amazon-Elastic-Kubernetes-Service-image18.png){width="5.0in" height="2.5416666666666665in"}



![WSÆloudFormation 2nd AWS CodePipeline continuously polls AWS CodeCommit repository for any new code change. It then triggers subsequent stages in the CI/CD pipeline. :ommit Amazon EC ](../../../media/AWS-DevOps-Module-6-23-Amazon-Elastic-Container-Registry-and-Amazon-Elastic-Kubernetes-Service-image19.png){width="5.0in" height="2.7083333333333335in"}



![3rd AWS CodePipeline sends the newly committed code revision to AWS CodeBuild. AWS CodeBuild builds a Docker container image from the code. AWS ](../../../media/AWS-DevOps-Module-6-23-Amazon-Elastic-Container-Registry-and-Amazon-Elastic-Kubernetes-Service-image20.png){width="5.0in" height="3.0833333333333335in"}



![co 4th AWS CodeBuild pushes the Docker container image tagged with build ID to Amazon ECR repository. AWS CodeBuild ](../../../media/AWS-DevOps-Module-6-23-Amazon-Elastic-Container-Registry-and-Amazon-Elastic-Kubernetes-Service-image21.png){width="5.0in" height="3.0833333333333335in"}



![AWS C 5th AWS CodePipeline uses AWS CloudFormation as a deployment tool and updates AWS CloudFormation stack, which re-defines the Amazon ECS task definition and service. ](../../../media/AWS-DevOps-Module-6-23-Amazon-Elastic-Container-Registry-and-Amazon-Elastic-Kubernetes-Service-image22.png){width="5.0in" height="3.4375in"}



![WS.CloudFormation I 6th AWS CloudFormation creates a new task definition (however, in this scenario, AWS CloudFormation is not needed to be run every time) by referencing the newly created Docker sc image and updates the Amazon ECS service. ](../../../media/AWS-DevOps-Module-6-23-Amazon-Elastic-Container-Registry-and-Amazon-Elastic-Kubernetes-Service-image23.png){width="5.0in" height="3.5416666666666665in"}



![AWS CloudFormation 7th Amazon ECS fetches the new container from Amazon ECR and replaces the old task with the new one, and restarts the service that completes the deployment. AWS CodeBuild Amazon ECS Amazon ECR ](../../../media/AWS-DevOps-Module-6-23-Amazon-Elastic-Container-Registry-and-Amazon-Elastic-Kubernetes-Service-image24.png){width="5.0in" height="3.2916666666666665in"}
