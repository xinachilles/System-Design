...
- ![Common use cases Data processing Real time . Amazon EMR Batch • Real-time stream processing Activity tracking Metrics generation IOT device data telemetry and metering Backends Applications and services Mobile 10T Third-party API requests • • training and -7 certification IT automation Policy engines Extending AWS services Infrastructure management 0 2020 Ama.•on ','.'eb Inc O' Its Al re-sewed ](../../../media/AWS-DevOps-Module-7-24-AWS-Lambda-and-AWS-Fargate-image1.png)
